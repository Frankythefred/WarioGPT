  ...
  if page == 'WarioGPT':
      ...
      if st.button('Submit'):
        ...
        if name == "Matty" and wah == "is matty cool?":
          ...
          st.markdown('<audio id="a" autoplay loop muted><source src="wario-dies-in-a-car-crash.mp3" type="audio/mpeg"></audio><script>document.getElementById("a").muted=false;</script>', unsafe_allow_html=True)
