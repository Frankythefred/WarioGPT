  ...
  if page == 'WarioGPT':
      ...
      if st.button('Submit'):
        ...
        if name == "Matty" and wah == "is matty cool?":
          ...
          st.markdown('<div style="display:flex; justify-content:center; overflow:hidden; height:110px;"><iframe width="110" height="200" src="https://www.myinstants.com/instant/wario-dies-in-a-car-crash-80322/embed/" frameborder="0" scrolling="no"></iframe></div>', unsafe_allow_html=True)
